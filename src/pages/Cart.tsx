                ...
                <div className="border border-w-200 dark:border-bk-600 rounded px-6 py-8 w-full sm:w-8/10 lg:w-340px h-430px flex flex-col justify-between">
                    ...
                    <div className="border-b border-w-200 dark:border-bk-600 flex flex-col gap-4 pb-6 font-medium">
                        <div className="flex justify-between">
                            ...
                            <p className="text-bk-900 dark:text-w-100 text-sm">$$</p>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div className="flex justify-between font-medium">
                        ...
                        <p className="text-sm text-bk-900 dark:text-w-100">$$</p>
                    </div>
                    <Link to={'/'} className='justify-center cursor-pointer flex items-center hover:opacity-85 text-white bg-bk-900 dark:bg-blue-400 py-3 px-6 gap-3 text-sm rounded-sm'>
                        {"Checkout"}
                    </Link>

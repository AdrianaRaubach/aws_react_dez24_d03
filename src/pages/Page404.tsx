            ...
            <div className='relative'>
                <motion.div
                    ...
                    <h2 className='absolute top-80 lg:top-100 xl:top-120 left-32 sm:left-40 lg:left-52 xl:left-65 text-3xl sm:text-5xl xl:text-7xl font-bold text-w-100'>
                        ERROR <br/>
                        <span className=' text-5xl sm:text-7xl xl:text-9xl'>404</span>
                    </h2>
                </motion.div>
                <motion.p
                    className='text-6xl lg:text-8xl xl:text-9xl left-20 sm:left-100 lg:left-130 xl:left-170 font-bold absolute sm:top-80 xl:top-110 animate-pulse text-bk-900 dark:text-w-100'
                    initial={{ x: -500, y: 0 }} 
                    animate={{ x: 0, y:0  }}
                    transition={{
                        duration: 1,
